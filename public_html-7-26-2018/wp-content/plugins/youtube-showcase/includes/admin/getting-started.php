...
<li><a href="#gs-sec-176">Live Demo Site</a></li>
...
<?php echo '</div>';
	...
	echo '>';
?>
<p class="about-description">YouTube Showcase Community V2.9.7 offers many new features, bug fixes and improvements.</p>
