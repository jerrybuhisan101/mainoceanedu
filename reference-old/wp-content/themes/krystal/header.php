                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="slide-bg-section">
                                            ...
                                            <div class="slide-bg-text">
                                                ...
                                                <div class = "notice center"><p class="center" style="    text-align: center;
    background: rgb(222, 15, 15);border-radius: 7px;">
    <strong>NOTICE:</strong><br>
 <strong>SHARING OF OCEAN EDU REFERENCE FILES</strong> to any person not working in OCEAN EDU is STRICTLY PROHIBITED. Anyone caught will have its corresponding penalties and may result to TERMINATION. </p></div>                                                 
