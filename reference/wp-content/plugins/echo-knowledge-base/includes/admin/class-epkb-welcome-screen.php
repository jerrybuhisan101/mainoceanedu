...
class EPKB_Welcome_Screen {
	...
	private function show_what_is_new() {   ?>
       ...
       <!-- <div class="eckb-whats-new">
		...
		<div class="row">
			<div class="col-12">
				<h4>3.4.0, May 30, 2018</h4>
				<ul>
					<li>New: Hook to change search mechanism</li>
					<li>Improved: Remove new lines and slashes from search</li>
					<li>Improved: logging</li>
					<li>Improved: enable KB installation for multisites (networked site)</li>
					<li>Improved: refactored code</li>
					<li>Fix: Saving KB Main Pages clears old pages</li>
					<li>Fix: WordPress search results page not affected by KB Template</li>
