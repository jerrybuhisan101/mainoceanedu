	...
	class Business_Kit_About {
		...
		public function load_assets( $hook ) {
			...
			if ( 'appearance_page_' . $this->page_slug === $hook ) {
				...
				wp_enqueue_style( 'business-kit-about', get_template_directory_uri() . '/includes/theme-info/css/about.css', array(), '1.0.4' );
				wp_enqueue_script( 'business-kit-about', get_template_directory_uri() . '/includes/theme-info/js/about.js', array( 'jquery' ), '1.0.4' );
				$js_vars = array(
